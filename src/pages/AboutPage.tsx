    ...
    <div className="pt-16 min-h-screen">
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Core Values */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-black text-center mb-12">Core Values</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div key={idx} className="text-center p-6 rounded-xl bg-gray-50 backdrop-blur-sm border border-gray-200">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="p-8 rounded-xl bg-gray-100 border border-gray-200">
              <h3 className="text-xl font-bold text-black mb-4">Leadership</h3>
              <p className="text-gray-600">Coming Soon</p>
            </div>
            <div className="p-8 rounded-xl bg-gray-100 border border-gray-200">
              <h3 className="text-xl font-bold text-black mb-4">Partners</h3>
              <p className="text-gray-600">Coming Soon</p>
            </div>
            <div className="p-8 rounded-xl bg-gray-100 border border-gray-200">
              <h3 className="text-xl font-bold text-black mb-4">Awards</h3>
              <p className="text-gray-600">Coming Soon</p>
            </div>
          </div>
        </div>
