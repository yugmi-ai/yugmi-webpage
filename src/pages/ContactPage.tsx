              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg text-black placeholder-gray-500 focus:border-black focus:outline-none transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg text-black placeholder-gray-500 focus:border-black focus:outline-none transition-colors resize-none"
            ...
            <div className="space-y-8">
              <div className="bg-gray-50 backdrop-blur-sm rounded-2xl p-8 border border-gray-200">
                ...
                <div className="space-y-4 text-gray-600">
                  ...
                  <div>
                    <strong className="text-black">Headquarters:</strong><br />
                    Noida, UP, India
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <button className="w-full bg-black text-white py-4 rounded-lg font-semibold hover:bg-gray-800 transition-all">
                  Request Consultation
                </button>
                <button className="w-full border border-gray-400 text-gray-600 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-all">
                  Become a Partner
                </button>
              </div>

              <div className="bg-gray-50 backdrop-blur-sm rounded-2xl p-8 border border-gray-200 text-center">
                <h4 className="text-lg font-semibold text-black mb-2">Ready for a Demo?</h4>
